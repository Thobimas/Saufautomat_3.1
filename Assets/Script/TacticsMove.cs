...
public class TacticsMove : MonoBehaviour
{
    ...
    protected void Init()
    {
        ...
        richtungsButton = GameObject.FindGameObjectsWithTag("RichtungsButton");  
    ...
    public void Move()
    {
        ...
        else
        {
            ...
            //checken ob Tile ein Ereignisfeld ist 
            GetCurrentTile();
            if(currentTile.ereignis != 0)
            {
                switch (currentTile.ereignis)
                {
                case 1:
                    Debug.Log("Ich hab noch nie!");
                    break;
                case 2:
                    Debug.Log("Aufgabe");
                    break;
                case 22:
                    Debug.Log("Deine Aufgabe ist vorbei");
                    break;
                case 222:
                    Debug.Log("Alle Aufgaben sind vorbei");
                    break;
                case 3:
                    Debug.Log("Würdest du eher");
                    break;
                case 4:
                    Debug.Log("Themenspiel! Wie cool...!");
                    break;
                case 100:
                    Debug.Log("Du bist an eine Kreuzung gekommen!");
                    ActivateRichtungsButton();
                    
                    //StartCoroutine(Dialog());

                    break;
                default:
                    Debug.Log("Etwas ist mit dem Ereignisfeld schiefgelaufen!");
                break;
                }
            }
    ...
    /**IEnumerator Dialog()
{
    Debug.Log("Ich bin im IEnumerator");
    var waitForButton = new WaitForUIButtons(richtungsButton[0], richtungsButton[1]);
    yield return waitForButton.Reset();
    if (waitForButton.PressedButton == richtungsButton[0])
    {
        // yes was pressed
    }
    else
    ...
    public void ActivateRichtungsButton()
    {
        foreach (GameObject button in richtungsButton)
        {
    ...
    public void DeactivateRichtungsButton()
    {
        foreach (GameObject button in richtungsButton)
        {
